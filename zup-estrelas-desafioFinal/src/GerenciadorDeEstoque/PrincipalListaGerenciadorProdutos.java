...
/* Programa Principal
Ofereça ao seu usuário a opção de navegação por um menu onde ele pode decidir se quer trabalhar com o menu de produtos alimentícios ou de limpeza ou encerrar o dia.
Nos submenus de produtos alimentícios e de limpeza de ofereça opções para utilizar todos os seus métodos e ofereça ao usuário as interações necessárias (ler do teclado as informações num caso de cadastro por exemplo) e a opção de retornar ao menu anterior.

- Por fim você deverá pensar numa funcionalidade legal para o estoque e implementá-la. Seja criativo e justifique a criação da sua funcionalidade num comentário à cima do método que corresponderá à essa funcionalidade.*/
